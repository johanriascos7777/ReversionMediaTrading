...
function App() {
    ...
    return (
      <div style={{
        ...
        <p style={{ margin: 0, fontSize: 13 }}>
          ...
          {wsStatus === 'disconnected' && 'Backend desconectado — verifica que el backend está encendido'}
  ...
  // 🧠 2. Extraer del backend: comparación, fusión de señal y backtest
  const comparison = market.fusedComparison
  const fused = {
    state: market.fusedState,
    explanation: market.fusedExplanation
  }
  ...
  if (comparison) {
    console.log(
      ...
      '\n  fusedState (Backend) =', market.fusedState,
